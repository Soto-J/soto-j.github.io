...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${geistSans.variable} ${geistMono.variable} bg-background font-sans dark:bg-background relative antialiased p-12`}
      >
        <ThemeProvider
          attribute="class"
          defaultTheme="system"
        ...
        >
          ...
          <main className="flex min-h-screen items-center justify-center w-[95%] max-w-4xl mx-auto">
            {children}
          </main>
        </ThemeProvider>
      </body>
